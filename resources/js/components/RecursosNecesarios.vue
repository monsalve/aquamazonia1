            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <form class="row">
                                    <div class="form-group col-md-2">
                                        ...
                                        >
                                            ...
                                            <option
                                                ...
                                                :key="index"
                                                >{{ ls.nombre_siembra }}</option
                                            >
                                        </select>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="t_actividad"
                                            >Tipo de Actividad:
                                        </label>
                                        <select
                                            class="form-control"
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        >
                                            ...
                                            <option
                                                v-for="(recurso,
                                                index) in listadoRecursos"
                                                :key="index"
                                                v-bind:value="recurso.id"
                                                >{{ recurso.recurso }}</option
                                            >
                                        </select>
                                    </div>
                                    <div class="form-group col-md-2">
                        ...
                        <div>
                            <table
                                class="table table-bordered table-striped table-sticky table-sm"
                            >
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row">
                            <div class="col-md-6">
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        @click="calcularDiferenciaTiempo()"
                                    >
                                        Calcular tiempo
                                    </button>
                                </div>
                                <div class="form-group">
                                    <label for="cantidad_recurso"
                                        >Cantidad</label
                                    >
                                    <input
                                        type="number"
                            ...
                            <div class="col-md-6" v-if="editando != 1">
                                ...
                                <span
                                    v-if="form.id_siembra.length == ''"
                                    class="text-danger mb-3"
                                >
                                    Debe seleccionar al menos una siembra
                                </span>
                                <div
                                    v-for="(item, index) in listadoSiembras"
                                    :key="index"
                                >
                                    <input
                                        type="checkbox"
                    ...
                    <div class="modal-footer">
                        ...
                        <button
                            v-if="editando != 1 && form.id_siembra.length != ''"
                            type="button"
                            class="btn btn-primary"
