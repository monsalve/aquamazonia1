                        ...
                        <div v-if="mostrar == 1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-1">
                                        ...
                                        <button
                                            ...
                                            @click="filtrarParametros()"
                                        >
                                            <i class="fas fa-search"></i>
                                        </button>
                                    </div>
                                    <div class="form-group  col-md-3">
                                        <label for="Generar excel"
                                            >Generar Excel:</label
                                        >
                                        <downloadexcel
                            ...
                            <div class="table-container" id="table-container2">
                                <h2>
                                    ...
                                    {{
                                        listadoParametros[0]
                                            ? listadoParametros[0].contenedor
                                            : ""
                                    }}
                                </h2>
                                <table
                                ...
                                >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="bg-secondary text-white">
                                            ...
                                            ></td>
                                            <td
                                                v-text="promedios.promedio_4_am"
                                            ></td>
                                            <td
                                                v-text="promedios.promedio_7_am"
                                            ></td>
                                            <td
                                                v-text="promedios.promedio_4_pm"
                                            ></td>
                                            <td
                                                v-text="promedios.promedio_8_pm"
                                            ></td>
                                            <td
                                                v-text="
                                                    promedios.promedio_temperatura
                                                "
                                            ></td>
                                            <td
                                                v-text="promedios.promedio_ph"
                                            ></td>
                                            <td
                                                v-text="
                                                    promedios.promedio_amonio
                                                "
                                            ></td>
                                            <td
                                                v-text="
                                                    promedios.promedio_nitrito
                                                "
                                            ></td>
                                            <td
                                                v-text="
                                                    promedios.promedio_nitrato
                                                "
                                            ></td>
                                            <td
                                                v-text="
                                                    promedios.promedio_otros
                                                "
                                            ></td>
                                        </tr>
                                    </tbody>
                        ...
                        >
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-for="(contenedor,
                                        index) in listadoParametrosEstanques"
                                        :key="index"
                                    >
                                        <td v-text="contenedor.contenedor"></td>
                                        <td v-text="contenedor.capacidad"></td>
                                        <td
                                            v-text="estados[contenedor.estado]"
                                        ></td>
                                        <td>
                                            <button
                                                class="btn btn-primary"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        >
                            ...
                            <div class="row">
                                <h4
                                    class="col-12 text-center text-primary my-4"
                                >
                                    Listado de estanques
                                </h4>
                                <div
                                    v-if="form.id_contenedor == ''"
                                    class="text-danger ml-2 col-12"
                                >
                                    Seleccionar al menos un estanque
                                </div>
                                <div
                                    v-for="(lc, index) in listadoEstanques"
                                    :key="index"
...
export default {
    ...
    methods: {
        ...
        filtrarParametros() {
            ...
            axios.post("api/filtro-parametros", data).then(response => {
                me.listadoParametros = response.data.calidad_agua;
                me.promedios = response.data.promedios;
            });
            axios.post("api/filtro-parametros-excel", data).then(response => {
        ...
        mostrarParametros(objeto) {
            ...
            axios
                .post("api/parametro-x-contenedor/" + objeto)
                .then(response => {
                    this.mostrar = 1;
            ...
            axios
                .post("api/parametro-x-contenedor-excel/" + objeto)
                .then(response => {
                    this.mostrar = 1;
        ...
        guardar() {
            ...
            this.form.post("api/parametros-calidad").then(({ data }) => {
                editando: 0;
        ...
        editar() {
            let me = this;
            this.form
                .put("api/parametros-calidad/" + this.form.id)
                .then(({ data }) => {
                    $("#modalParametros").modal("hide");
        ...
        eliminarParametros(objeto) {
            ...
            Swal.fire({
                title: "Estás seguro?",
                text:
                    "Una vez eliminado, no se puede recuperar los registros asociados a este ID",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    axios
                        .delete("api/parametros-calidad/" + objeto)
                        .then(({ data }) => {
                            me.listar();
                        });
                }
