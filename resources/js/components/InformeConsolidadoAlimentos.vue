                      ...
                      <div class="row">
                        <div class="form-row col-12">
                          <div class="form-group col-3">
														...
														<select name="estado_siembra" class="custom-select" id="estado_siembra" v-model="estado_siembra" @click.prevent="listar(1, '', estado_siembra, '')">
													...
													<div class="form-group col-3" v-show="estado_siembra==1">
														...
														<select name="estado_siembra" class="custom-select" id="estado_siembra" v-model="siembra_activa"  @click.prevent="listar(1, siembra_activa, '', '')">
													...
													<div class="form-group col-3" v-show="estado_siembra==0">
														...
														<select name="estado_siembra" class="custom-select" id="estado_siembra"  v-model="siembra_inactiva"  @click.prevent="listar(1, siembra_inactiva, '', '')">
															<option value="">Todas</option>
													...
													<div class="form-group col-md-2">
														...
														<select class="form-control" id="alimento" v-show="estado_siembra==1" v-model="alimento_s" @click.prevent="listar(1, siembra_activa, '', alimento_s)">
																<option selected> Seleccionar</option>
																<option v-for="(alimento, index) in listadoAlimentos" :key="index" v-bind:value="alimento.id">{{alimento.alimento}}</option>
														</select>
														<select class="form-control" id="alimento" v-show="estado_siembra==0" v-model="alimento_s" @click.prevent="listar(1, siembra_inactiva, '', alimento_s)">
                        ...
                        <table class="table-sticky table table-sm table-hover table-bordered">
                          ...
                          <tbody>
                            <tr v-for="(lrn, index) in listado" :key="index">
                              ...
                              <td>{{lrn.tipo_actividad == 1 ? lrn.actividad='Alimentacion' : ''}}</td> 
                              <td>{{lrn.alimento}}</td>
...
import downloadexcel from "vue-json-excel"
  export default {
    ...
    methods:{
      ...
      listar(page, id_siembra, estado_siembra, id_alimento){
        let me = this;
        axios.get("api/informes-alimentos?page="+page+'&id_siembra='+id_siembra+'&estado_siembra='+estado_siembra+'&id_alimento='+id_alimento)
