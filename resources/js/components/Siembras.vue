                            ...
                            <div class="row">
                                <div class="form-row col-12">
                                    <div class="form-group col-3">
                                        <label for="estado_siembta"
                                            >Estado de siembra</label
                                        >
                                        <select
                                            name="estado_siembra"
                                            class="custom-select"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSiembralLabel">
                            Crear siembra
                        </h5>
                        <button
                            type="button"
                    ...
                    <div class="modal-body">
                        <div class="container row">
                            ...
                            <div class="form-group row col-md-4">
                                <div class="col-sm-12 col-md-12 text-left">
                                    <label for="nombre_siembra"
                                        >Nombre de Siembra</label
                                    >
                        ...
                        "
                                    ...
                                    >
                                        ...
                                        <td
                                            v-text="
                                                nombresEspecies[item.id_especie]
                                            "
                                        ></td>
                                        <td>
                                            <span
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 text-right">
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        @click="
                                            guardarEdita(form.id_contenedor)
                                        "
                                        class="btn btn-primary"
                                    >
                                        Actualizar
                    ...
                    <div class="modal-body">
                        <form class="row" id="editarAlimentacion">
                            ...
                            <div class="form-group col-md-3">
                                <label
                                    for="fecha_registro_alimentacion"
                                    class=""
                                    >Fecha (*)</label
                                >
                                <input
                            ...
                            <div class="form-group col-md-3">
                                <label for="minutos hombre" class=""
                                    >Minutos hombre</label
                                >
                                <input
                                    type="number"
                                    class="form-control"
                    ...
                    <div class="modal-header">
                        ...
                        >
                            ...
                            <span v-if="ver_registros == 0"
                                ><i class="fas fa-arrow-left"></i> Ver listado
                                de registros</span
                            >
                        </button>
                        <button
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        ></td>
                                        <td
                                            v-text="registro.fecha_registro"
                                        ></td>
                                        <td
                                            v-text="
                                                registro.peso_ganado == null
                                                    ? '-'
                                                    : registro.peso_ganado +
                                                      'gr'
                                            "
                                        ></td>
                                        <td
...
export default {
    ...
    methods: {
        ...
        guardarEdita(objeto) {
            ...
            axios
                .post("api/anadir-especie-siembra", data)
                .then(({ response }) => {
        ...
        nombreEspecie() {
            ...
            axios.get("api/especies").then(function(response) {
                ...
                auxEspecie.forEach(
                    element =>
                        (me.nombresEspecies[element.id] = element.especie)
                );
            });
        },
        abrirIngreso(id) {
        ...
        guardarRecursos() {
            ...
            if (me.editandoAlimento == 0) {
                if (me.form.id_alimento != "" && me.form.fecha_ra != "") {
                    axios
                        .post("api/recursos-necesarios", me.form)
                        .then(({ data }) => {
                            me.listar(1, "");
