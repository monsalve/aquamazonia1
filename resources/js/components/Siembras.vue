              ...
              <div class="row">
                <div class="form-row col-12">
                  <div class="form-group col-3">
                    ...
                    <select name="estado_siembra" class="custom-select" id="estado_siembra" v-model="estado_siembra" @click.prevent="filtrarSiembras(estado_siembra, '')">
                  ...
                  <div class="form-group col-3" v-show="estado_siembra==1">
                    ...
                    <select name="estado_siembra" class="custom-select" id="estado_siembra" v-model="siembra_activa" @click.prevent="filtrarSiembras(1,siembra_activa)">
                  ...
                  <div class="form-group col-3" v-show="estado_siembra==0">
                    ...
                    <select name="estado_siembra" class="custom-select" id="estado_siembra"  v-model="siembra_inactiva" @click.prevent="filtrarSiembras(0,siembra_inactiva)">
                      <option value="">Todas</option>
